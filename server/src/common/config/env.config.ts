...
export const envConfig = (): EnvConfig => {
    ...
    return {
		...
		mongodbUri: process.env.MONGODB_URI || `mongodb://localhost:27017/BM`,
		...
		facebookId: process.env.FACEBOOK_ID || `some-very-strong-secret`,
		facebookSecret: process.env.FACEBOOK_SECRET || `some-very-strong-secret`,
        jwt: {
